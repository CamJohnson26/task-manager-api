...
def create_task_query(connection_pool, user_id, title, description, task_type, due_date, priority, status, effort, percent_completed):
    conn = None
    try:
        ...
        cursor.execute("""
            INSERT INTO public.task (
                user_id, title, description, type, due_date, priority, status, effort, percent_completed
            ) VALUES (
                %s, %s, %s, %s, %s, %s, %s, %s, %s
